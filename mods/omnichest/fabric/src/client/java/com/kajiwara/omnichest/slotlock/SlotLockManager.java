...
public final class SlotLockManager {
     ...
     * <p>
     * 例えば
     * {@link com.kajiwara.omnichest.mixin.GenericContainerScreenMixin}
    ...
    private static ItemStack safeGet(Inventory inv, int slot) {
        try {
            ...
            OmniChest.LOGGER.debug("[omnichest] retrackItemLocks: getItem 失敗 slot={}", slot);
        ...
        for (Listener l : listeners) {
            try {
                ...
                OmniChest.LOGGER.warn(
                        "[omnichest] SlotLockManager listener throws: {}", t.toString());
            }
        }
    }
}
