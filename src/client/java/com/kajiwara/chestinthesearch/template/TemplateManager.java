package com.kajiwara.chestinthesearch.template;

import com.kajiwara.chestinthesearch.template.category.ItemCategoryResolver;
...
import com.kajiwara.chestinthesearch.template.data.ItemRef;
import com.kajiwara.chestinthesearch.template.data.SlotRule;
import com.kajiwara.chestinthesearch.template.data.TemplateKind;
import com.kajiwara.chestinthesearch.template.storage.TemplateStorage;
 ...
 * 内部の {@link TemplateStorage}, {@link com.kajiwara.chestinthesearch.template.apply.SlotPlanner}
...
public final class TemplateManager {
     ...
     * {@link com.kajiwara.chestinthesearch.template.apply.MoveQueue} の tick 購読、
     * {@link TemplateConfig} の load を済ませる。
     */
    public static void register() {
        TemplateConfig.get();
        TemplateStorage.get();
        com.kajiwara.chestinthesearch.template.apply.MoveQueue.get().register();
    }
