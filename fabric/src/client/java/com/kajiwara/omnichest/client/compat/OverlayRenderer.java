 ...
 * {@link GuiGraphics#fill} で短いシーケンスを描いているだけだが、 他 MOD (Inventory Profiles
 * Next など) が同じスロット位置に独自描画を重ねるケースで衝突しやすい。
 *
 * <p>
 * このクラスは:
 * <ol>
 *   <li>{@link RenderStateGuard#withGuiPose(GuiGraphics, String, Runnable)} で matrix を隔離</li>
 ...
 * Z 軸の前後関係は {@code GuiGraphics} 内部の描画順 (= submit 順) に従う。
 *
 * <p>
...
public final class OverlayRenderer {
     ...
     */
    public static void runSafe(GuiGraphics g, String tag, Runnable body) {
     ...
     */
    public static void runSafeFlat(GuiGraphics g, String tag, Runnable body) {
        runSafe(g, tag, body);
    }
}
